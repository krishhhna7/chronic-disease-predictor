...
with st.sidebar:
    selected = option_menu('Diagnosis of Chronic Diseases using ML',
                          ['Diabetes',
                            'Heart Disease',
                            'Parkinsons Disease'],
...
if (selected == "Parkinsons Disease"):
    ...
    st.title("Diagnose Parkinson's Disease")
...
if (selected == 'Heart Disease'):
  ...
  st.title('Diagnose Heart Disease')
